...
<head>
	...
	<title>Admin - My Application</title>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<?php if($this->session->userdata('err')):?>
									<div class="alert alert-danger" role="alert"><strong>Whoopss!!! </strong>Username dan Password anda Salah!</div>
								<?php endif;?>
						...
						<div class="text-center text-light">
							<a href="<?php echo base_url($this->uri->segment(1));?>/forgot" class="text-light">Forgot password?</a>
						</div>
					</div>
				</div>
			</div>
